...
function displayAnimalInfo() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=funny+" + animal + "&limit=8&api_key=dc6zaTOxFJmzC";
    ...
    $.ajax({
        ...
        // loop for still and animated gifs
